...
app.get("/random", (req, res) => {
  const entry = Math.floor(Math.random()*jokes.length);
  res.json(jokes[entry]);
})
...
app.post("/jokes", (req, res) => {
  ...
  const data = { id:id, jokeText:jokeText, jokeType:jokeType };
  jokes.push(data); 
  res.send(data)
});
...
app.put("/jokes/:id", (req, res) => {
  ...
  const data = { id:id , jokeText:newjokeText, jokeType:newjokeType};
